...
export type GetLessongBySlugQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']>;
}>;


export type GetLessongBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, videoId: string, description?: string | null, teacher?: { __typename?: 'Teacher', bio: string, avatarURL: string, name: string } | null } | null };
...
export const GetLessongBySlugDocument = gql`
...
/**
 * __useGetLessongBySlugQuery__
 *
 * To run a query within a React component, call `useGetLessongBySlugQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetLessongBySlugQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetLessongBySlugQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useGetLessongBySlugQuery(baseOptions?: Apollo.QueryHookOptions<GetLessongBySlugQuery, GetLessongBySlugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLessongBySlugQuery, GetLessongBySlugQueryVariables>(GetLessongBySlugDocument, options);
      }
export function useGetLessongBySlugLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLessongBySlugQuery, GetLessongBySlugQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLessongBySlugQuery, GetLessongBySlugQueryVariables>(GetLessongBySlugDocument, options);
        }
export type GetLessongBySlugQueryHookResult = ReturnType<typeof useGetLessongBySlugQuery>;
export type GetLessongBySlugLazyQueryHookResult = ReturnType<typeof useGetLessongBySlugLazyQuery>;
export type GetLessongBySlugQueryResult = Apollo.QueryResult<GetLessongBySlugQuery, GetLessongBySlugQueryVariables>;
